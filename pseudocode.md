...
This document outlines the core Value Iteration algorithm used in this project and contrasts it with the theoretical foundation provided in *Artificial Intelligence: Foundations and Computational Agents* (Poole and Mackworth).
